...
public final class Branch_120_4_ChunkLight implements BranchChunkLight {
    ...
    public Branch_120_4_ChunkLight(final World world) { this(((CraftWorld) world).getHandle()); }

    public Branch_120_4_ChunkLight(final ServerLevel worldServer) {
        this(worldServer, new byte[worldServer.getSectionsCount() + 2][], new byte[worldServer.getSectionsCount() + 2][]);
    }

    public Branch_120_4_ChunkLight(final ServerLevel worldServer, final byte[][] blockLights, final byte[][] skyLights) {
        this.worldServer = worldServer;
        this.blockLights = blockLights;
        this.skyLights = skyLights;
        Arrays.fill(blockLights, Branch_120_4_ChunkLight.EMPTY);
        Arrays.fill(skyLights, Branch_120_4_ChunkLight.EMPTY);
    }
    ...
    public void setBlockLight(final int sectionY, final byte[] blockLight) {
        this.blockLights[Branch_120_4_ChunkLight.indexFromSectionY(this.worldServer, sectionY)] = blockLight;
    }

    public void setSkyLight(final int sectionY, final byte[] skyLight) {
        this.skyLights[Branch_120_4_ChunkLight.indexFromSectionY(this.worldServer, sectionY)] = skyLight;
    }

    public byte[] getBlockLight(final int sectionY) {
        return this.blockLights[Branch_120_4_ChunkLight.indexFromSectionY(this.worldServer, sectionY)];
    }

    public byte[] getSkyLight(final int sectionY) {
        return this.skyLights[Branch_120_4_ChunkLight.indexFromSectionY(this.worldServer, sectionY)];
    }
