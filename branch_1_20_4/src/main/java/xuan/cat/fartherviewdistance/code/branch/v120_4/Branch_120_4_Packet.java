...
public final class Branch_120_4_Packet implements BranchPacket {
    ...
    public Consumer<Player> sendChunkAndLight(final BranchChunk chunk, final BranchChunkLight light, final boolean needTile,
        ...
        final LevelLightEngine levelLight = ((Branch_120_4_Chunk) chunk).getLevelChunk().level.getLightEngine();
        serializer.writeInt(chunk.getX());
        serializer.writeInt(chunk.getZ());
        this.handleChunk.write(serializer, ((Branch_120_4_Chunk) chunk).getLevelChunk(), needTile);
        ...
        final ClientboundLevelChunkWithLightPacket packet = new ClientboundLevelChunkWithLightPacket(
                ((Branch_120_4_Chunk) chunk).getLevelChunk(), levelLight, null, null, false);
        try {
            // 適用於 paper
