package xuan.cat.fartherviewdistance.module.listener;
...
public final class ChunkListener implements Listener {
    ...
    public ChunkListener(final ChunkServer chunkServer, final ServerPacket serverPacket, final ServerWorld serverWorld) {
    ...
    public void event(final PlayerJoinEvent event) {
        ...
        // accordingly.
        this.serverWorld.injectPlayer(event.getPlayer());
    }
